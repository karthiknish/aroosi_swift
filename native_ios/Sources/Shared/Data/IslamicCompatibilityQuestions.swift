...
/// Islamic Compatibility Questions organized by category
/// Each category has weighted importance and contains specific questions
public struct IslamicCompatibilityQuestions {
    
    /// Get all compatibility categories with their questions
    public static func getCategories() -> [IslamicCompatibilityCategory] {
        return [
            religiousPracticeCategory(),
            familyStructureCategory(),
            culturalValuesCategory(),
            financialManagementCategory(),
            educationCareerCategory(),
            socialLifeCategory(),
    ...
    public static func getTotalWeight() -> Double {
        return getCategories().reduce(0.0) { $0 + $1.weight }
    }
    
    // MARK: - Category 1: Religious Practice (20% weight)
    
    private static func religiousPracticeCategory() -> IslamicCompatibilityCategory {
        return IslamicCompatibilityCategory(
    ...
    // MARK: - Category 2: Family Structure (18% weight)
    
    private static func familyStructureCategory() -> IslamicCompatibilityCategory {
        return IslamicCompatibilityCategory(
            id: "family_structure",
    ...
    // MARK: - Category 3: Cultural Values (12% weight)
    
    private static func culturalValuesCategory() -> IslamicCompatibilityCategory {
        return IslamicCompatibilityCategory(
            id: "cultural_values",
    ...
    // MARK: - Category 4: Financial Management (15% weight)
    
    private static func financialManagementCategory() -> IslamicCompatibilityCategory {
        return IslamicCompatibilityCategory(
    ...
    // MARK: - Category 5: Education & Career (10% weight)
    
    private static func educationCareerCategory() -> IslamicCompatibilityCategory {
        return IslamicCompatibilityCategory(
            id: "education_career",
    ...
    // MARK: - Category 6: Social Life (8% weight)
    
    private static func socialLifeCategory() -> IslamicCompatibilityCategory {
        return IslamicCompatibilityCategory(
            id: "social_life",
            name: "Social Life",
    ...
    // MARK: - Category 7: Conflict Resolution (10% weight)
    
    private static func conflictResolutionCategory() -> IslamicCompatibilityCategory {
        return IslamicCompatibilityCategory(
    ...
    // MARK: - Category 8: Life Goals (7% weight)
    
    private static func lifeGoalsCategory() -> IslamicCompatibilityCategory {
        return IslamicCompatibilityCategory(
            id: "life_goals",
            name: "Life Goals",
